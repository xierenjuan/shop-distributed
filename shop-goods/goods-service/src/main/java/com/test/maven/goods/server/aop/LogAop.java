package com.test.maven.goods.server.aop;
...
public class LogAop {
     ...
     * 拦截controller请求参数
     */
    @Pointcut("execution(public * com.test.maven.goods.server.controller..*.*(..))")
     ...
     * 拦截异常的时候返回参数
     */
    @Pointcut("execution(public * com.test.maven.goods.server.exception..*.*(..))")

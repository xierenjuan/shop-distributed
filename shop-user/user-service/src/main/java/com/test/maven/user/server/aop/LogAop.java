package com.test.maven.user.server.aop;
...
public class LogAop {
    ...
    @Pointcut("execution(public * com.test.maven.user.server.controller..*.*(..))")
    public void controllerAspect(){}

    @Pointcut("execution(public * com.test.maven.user.server.exception..*.*(..))")
